...
| Projet | Ce que c'est |
| :-- | :-- |
| [**vision-part-inspection**](https://github.com/MEHOUACHIAHMED/vision-part-inspection) | Inspection de pièces par vision : détecter les défauts sur une ligne, en Python. |
| [**yolo-object-detection**](https://github.com/MEHOUACHIAHMED/yolo-object-detection) | Détection d'objets en temps réel avec YOLO. |
| [**pytorch-image-classifier**](https://github.com/MEHOUACHIAHMED/pytorch-image-classifier) | Classification d'images entraînée avec PyTorch. |
| [**genesis-showcase**](https://github.com/MEHOUACHIAHMED/genesis-showcase) | Vitrine web d'un projet énergétique. |
